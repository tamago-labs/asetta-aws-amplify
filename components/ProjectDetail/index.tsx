    ...
    const [messages, setMessages] = useState<Message[]>([
        {
            id: '1',
            type: 'ai',
            content: `Welcome to ${project?.name}. I'm your AI investment assistant, here to help you with everything from understanding the investment opportunity to completing your KYC process. This premium ${project?.type.toLowerCase()} offers excellent returns with a ${project?.yieldRate} annual yield. How can I assist you today?`,
            timestamp: new Date()
        }
    ]);
    ...
    const handleSend = () => {
        ...
        setTimeout(() => {
            ...
            if (inputValue.toLowerCase().includes('kyc') || inputValue.toLowerCase().includes('verification')) {
                ...
                aiResponse = `This property generates a ${project?.yieldRate} annual yield through rental income. With ${project?.occupancy} occupancy and stable long-term tenants, it provides consistent monthly distributions. Would you like me to calculate potential returns for a specific investment amount?`;
            } else {
    ...
    return (
        <div className="h-screen grid grid-cols-2">
            ...
            <div className="flex-1 bg-gray-50 overflow-y-auto">
                ...
                {/* Content continues with all tabs... */}
